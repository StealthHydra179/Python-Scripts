...
output = open("commercial-listing_output.txt", "w", encoding="utf-8")
...
for currentLine in file:
    ...
    if lineN == 9:
        ...
        output.write(f"INSERT INTO CONTENT_ATTRIBUTE (CONTENT_ID, ATTR_KEY, ATTR_SUB_KEY, VALUE) VALUES ((SELECT CONTENT_ID FROM CONTENT WHERE CONTENT_KEY = '{urlName}' AND PLATFORM_ID=(SELECT PLATFORM_ID FROM PLATFORM WHERE ROOT_DOMAIN='jyconstruction.ca')), 'TITLE', '1', '{locationName}');\n")
