...
plt.xlim(0,)
# y1 = -0.000322*x - 0.026
# y2 = -0.000026*x-0.0347
# y3 = -0.0000018*x-0.03823
#
...
#graph the following function M(t) = 0.01086 * 10^(-0.008873 t) - 0.03872
# y4 = 0.01086 * 10**(-0.008873 * x) - 0.03872
# plt.plot(x, y4, '-r', label='exponential fit')

# plt.axhline(0, color='black', linewidth=0.5)
# plt.xlim(90,110)

#graph a line segment from the first point to the last point
plt.plot([data[0][0], data[0][len(data[0])-1]], [mechanical_energy[0], mechanical_energy[len(data[0])-1]], '-r', label='linear fit')
